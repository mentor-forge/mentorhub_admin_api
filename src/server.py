...
This is a Flask + MongoDB API for the Admin service in the Mentor Hub system.
"""
...
logger.info("  /dev/register - Developer Edition registration endpoint")
...
if __name__ == "__main__":
    api_port = config.COORDINATOR_API_PORT
